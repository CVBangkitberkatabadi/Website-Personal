...
<html>
<head>
	<title>CV Bangkit Berkah Abadi</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +62895-1416-4945</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> azwa@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>CV Bangkit Berkat Abadi</span>
				</div>
			</center>
		</div>
	</div>
