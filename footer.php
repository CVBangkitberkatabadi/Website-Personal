	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>CV BANGKIT BERKAT ABADI</b></h3>
					<p>Jl. terusan pasir koja</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +62895-1416-4945</p>
					<p><i class="glyphicon glyphicon-envelope"></i> azwa@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
		...
		<div class="copy" style="background-color: #ff8680; padding: 5px; color: #fff; text-align: center;">
			<span>Copyright&copy; CV Bangkit Berkat Abadi @2023</span>
		</div>
	</footer>
